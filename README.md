...
│
├── 2311102137_CRUD-MURID/       # Folder utama aplikasi CRUD Murid
│   │
│   ├── views/                   # Folder untuk tampilan (frontend)
│   │   ├── add.html             # Halaman form tambah data murid
│   │   ├── index.html           # Halaman utama (tabel data murid)
│   │   └── edit.html            # Halaman form edit data murid
│   │
│   ├── server.js                # Backend Node.js (routing & CRUD)
...
[https://drive.google.com/drive/folders/1s6kYwYE4jXiHk-lRPuJM2OaW0a6DJOhK?usp=sharing]